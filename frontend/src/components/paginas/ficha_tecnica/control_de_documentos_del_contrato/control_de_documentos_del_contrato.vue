<template >
  ...
  <!--<div class="containerPrueba">-->
    <h1>Lista de control de documentos del contrato</h1>
    <br>
    ...
    <table class="table" style="font-family: 'Bahnschrift'">
      ...
      <!--  <th scope="col" style="font-weight: bold" align="center">Nombre</th>-->
        ...
        <th scope="col" style="font-weight: bold"  >
          ...
          <span class="arrow" @click="ordenarPor('nombre_del_documento')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          Fecha de entrega
          <span class="arrow" @click="ordenarPor('fecha_de_entrega')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          Responsable
          <span class="arrow" @click="ordenarPor('responsable')">
              &#8593;&#8595;
            </span>
        </th>
      ...
      <tr v-for="(item, index) in lista_control_de_documentos_del_contrato" :key="index">
    ...
    <button class="btn btn-icon-text elemento" @click="abrirPopupInsertar" type="submit">
      ...
      Crear nuevo control del documento
    </button>
      ...
      <div class="popup-contenidoPlazos">
        ...
        <div class="form-group col" style="align-items: baseline;">
          ...
          <div class="col-md-12">
            ...
            <input type="text" class="form-control" name="insertar_nombre_del_documento" id="insertar_nombre_del_documento" v-model="popupItemNuevo.nombre_del_documento" required >
          </div>
          ...
          <div class="col-md-12">
            ...
            <input type="date" class="form-control" name="insertar_fecha_de_entrega" id="insertar_fecha_de_entrega" v-model="popupItemNuevo.fecha_de_entrega" required>
          </div>
          ...
          <div class="col-md-12">
            <h5>Responsable:</h5>
            <input type="text" class="form-control" name="insertar_responsable" id="insertar_responsable" v-model="popupItemNuevo.responsable" required>
          </div>
        </div>
    ...
    <div class="popup modal fade show d-block" v-if="mostrarPopup" style="font-family: 'Bahnschrift'">
      <div class="popup-contenidoPlazos" style="top: 33%">
        ...
        <div class="form-group col" style="align-items: baseline;">
          ...
          <div class="col-md-12">
            <h5>Nombre del documento:</h5>
            <input type="text" class="form-control" name="insertar_nombre_del_documento" id="insertar_nombre_del_documento" v-model="popupItem.nombre_del_documento" required >
          </div>
          ...
          <div class="col-md-12">
            <h5>Fecha de entrega:</h5>
            <input type="date" class="form-control" name="insertar_fecha_de_entrega" id="insertar_fecha_de_entrega" v-model="popupItem.fecha_de_entrega" required>
          </div>
          ...
          <div class="col-md-12">
            <h5>Responsable:</h5>
            <input type="text" class="form-control" name="insertar_responsable" id="insertar_responsable" v-model="popupItem.responsable" required>
          </div>
        </div>
...
export default {
  data() {
    return {
      lista_control_de_documentos_del_contrato: [], // Array para almacenar los datos de la API
     ...
     // popupItemNuevo: null,
      ...
      /////para filtrar
      lista_control_de_documentos_del_contrato_original: [], // Lista original
  ...
  mounted() {
    this.obtenerControl_de_documentos_del_contrato();
  ...
  methods: {
    obtenerControl_de_documentos_del_contrato() {
      axios.get('http://127.0.0.1:8000/api/control_de_documentos_del_contrato/0')
          .then(response => {
            this.lista_control_de_documentos_del_contrato = response.data["control_de_documentos_del_contrato"];
            this.lista_control_de_documentos_del_contrato_original = response.data["control_de_documentos_del_contrato"];

            // this.lista_control_de_documentos_del_contrato_original = response.data["control_de_documentos_del_contrato"];
           // this.lista_control_de_documentos_del_contrato = [...this.lista_control_de_documentos_del_contrato_original]; // Copia la lista original a la lista filtrada
          })
          .catch(error => {
            console.error(error);
          });
    ...
    eliminar(id){
      ...
      const url = `http://127.0.0.1:8000/api/control_de_documentos_del_contrato/delete/${id}`;
      axios.delete(url)
          .then(response => {
            this.obtenerControl_de_documentos_del_contrato();
    ...
    guardarCambios() {
      ...
      if (this.popupItem.nombre_del_documento === '' ||
          this.popupItem.fecha_de_entrega === null ||
          this.popupItem.responsable === ''
      ) {
      ...
      const url = `http://127.0.0.1:8000/api/control_de_documentos_del_contrato/put/${this.popupItem.id}`;
      const payload = {
        nombre_del_documento: this.popupItem.nombre_del_documento,
        fecha_de_entrega: this.popupItem.fecha_de_entrega,
        responsable: this.popupItem.responsable,
      ...
      axios.put(url, payload)
          .then(response => {
            this.obtenerControl_de_documentos_del_contrato(); // Actualizar la tabla si es necesario
    ...
    guardar_nuevo() {
      ...
      if (this.popupItemNuevo.nombre_del_documento === '' ||
          this.popupItemNuevo.fecha_de_entrega === null ||
          this.popupItemNuevo.responsable === ''
      ){
      ...
      const url = 'http://127.0.0.1:8000/api/control_de_documentos_del_contrato/post/';
      const payload = {
        nombre_del_documento: this.popupItemNuevo.nombre_del_documento,
        fecha_de_entrega: this.popupItemNuevo.fecha_de_entrega,
        responsable: this.popupItemNuevo.responsable,
      };
    ...
    ordenarPor(columna) {
      ...
      this.lista_control_de_documentos_del_contrato.sort((a, b) => {
    ...
    aplicarFiltro() {
      if (this.quitarFiltros) {
       ...
       // this.lista_control_de_documentos_del_contrato = [...this.lista_control_de_documentos_del_contrato_original];
      } else {
        // Aplica el filtro por nombre
        const filteredList = this.lista_control_de_documentos_del_contrato_original.filter(control => {
          const nombreMatch = (!this.filtroNombre || control.nombre_del_documento.includes(this.filtroNombre));
          return nombreMatch;
        });

        this.lista_control_de_documentos_del_contrato = filteredList;
      }
    },
