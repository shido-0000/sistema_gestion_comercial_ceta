    ...
    <table class="table" style="font-family: 'Bahnschrift'">
      ...
      <!--  <th scope="col" style="font-weight: bold" align="center">Nombre</th>-->
        ...
        <th scope="col" style="font-weight: bold" >
          Valor
          <span class="arrow" @click="ordenarPorValor('valor')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          Moneda
          <span class="arrow" @click="ordenarPor('moneda')">
              &#8593;&#8595;
            </span>
        </th>
      ...
      <tr v-for="(item, index) in lista_valor_del_contrato_por_los_servicios_comercializados" :key="index">
    ...
    <div class="popup modal fade show d-block" v-if="mostrarPopup_de_Insertar" style="font-family: 'Bahnschrift'">
      <div class="popup-contenidoPlazos">
        ...
        <div class="form-group col" style="align-items: baseline;">
          <div class="col-md-12">
            <h5>Valor:</h5>
            <input type="number" class="form-control" name="insertar_valor" id="insertar_valor" v-model="popupItemNuevo.valor" required min="1">
          </div>
          ...
          <div class="col-md-12">
            <h5>Moneda:</h5>
            <input type="text" class="form-control" name="insertar_moneda" id="insertar_moneda" v-model="popupItemNuevo.moneda" required >
          </div>
        </div>
    ...
    <div class="popup modal fade show d-block" v-if="mostrarPopup" style="font-family: 'Bahnschrift'">
      <div class="popup-contenidoPlazos" style="top: 33%">
        ...
        <div class="form-group col" style="align-items: baseline;">
          <div class="col-md-12">
            <h5>Valor:</h5>
            <input type="number" class="form-control" name="insertar_valor" id="insertar_valor" v-model="popupItem.valor" required >
          </div>
          ...
          <div class="col-md-12">
            <h5>Moneda:</h5>
            <input type="text" class="form-control" name="insertar_moneda" id="insertar_moneda" v-model="popupItem.moneda" required >
          </div>
        </div>
...
export default {
  data() {
    return {
      lista_valor_del_contrato_por_los_servicios_comercializados: [], // Array para almacenar los datos de la API
     ...
     // popupItemNuevo: null,
      ...
      /////para filtrar
      lista_valor_del_contrato_por_los_servicios_comercializados_original: [], // Lista original
  ...
  mounted() {
    this.obtenerValor_del_contrato_por_los_servicios_comercializados();
  ...
  methods: {
    obtenerValor_del_contrato_por_los_servicios_comercializados() {
      axios.get('http://127.0.0.1:8000/api/valor_del_contrato_por_los_servicios_comercializados/0')
          .then(response => {

            this.lista_valor_del_contrato_por_los_servicios_comercializados = response.data["valor_del_contrato_por_los_servicios_comercializados"];

            //     this.lista_valor_del_contrato_por_los_servicios_comercializados_original = response.data["valor_del_contrato_por_los_servicios_comercializados"];
         //   this.lista_valor_del_contrato_por_los_servicios_comercializados = [...this.lista_valor_del_contrato_por_los_servicios_comercializados_original]; // Copia la lista original a la lista filtrada
          })
          .catch(error => {
            console.error(error);
          });
    ...
    eliminar(id){
      ...
      const url = `http://127.0.0.1:8000/api/valor_del_contrato_por_los_servicios_comercializados/delete/${id}`;
      axios.delete(url)
          .then(response => {
            this.obtenerValor_del_contrato_por_los_servicios_comercializados();
    ...
    guardarCambios() {
      ...
      if (this.popupItem.valor === 0 ||
          this.popupItem.moneda === ''
      ) {
      ...
      const url = `http://127.0.0.1:8000/api/valor_del_contrato_por_los_servicios_comercializados/put/${this.popupItem.id}`;
      const payload = {
        valor: this.popupItem.valor,
        moneda: this.popupItem.moneda,
      ...
      axios.put(url, payload)
          .then(response => {
            this.obtenerValor_del_contrato_por_los_servicios_comercializados(); // Actualizar la tabla si es necesario
    ...
    guardar_nuevo() {
      ...
      if (this.popupItemNuevo.valor === 0 ||
          this.popupItemNuevo.moneda === ''
      ){
      ...
      const url = 'http://127.0.0.1:8000/api/valor_del_contrato_por_los_servicios_comercializados/post/';
      const payload = {
        valor: this.popupItemNuevo.valor,
        moneda: this.popupItemNuevo.moneda,
      };

      axios.post(url, payload)
          .then(response => {
            // Lógica después de crear el tipo de norma
            this.popupItemNuevo.descripcion = ''; // Limpiar el campo de texto
    ...
    ordenarPor(columna) {
      ...
      this.lista_valor_del_contrato_por_los_servicios_comercializados.sort((a, b) => {
    ...
    aplicarFiltro() {
      if (this.quitarFiltros) {
        ...
        this.lista_valor_del_contrato_por_los_servicios_comercializados = [...this.lista_valor_del_contrato_por_los_servicios_comercializados_original];
      } else {
        // Aplica el filtro por nombre
        const filteredList = this.lista_valor_del_contrato_por_los_servicios_comercializados_original.filter(valor_del_contrato => {
          const nombreMatch = (!this.filtroNombre || valor_del_contrato.valor.includes(this.filtroNombre));
          return nombreMatch;
        });

        this.lista_valor_del_contrato_por_los_servicios_comercializados = filteredList;
      }
    },
