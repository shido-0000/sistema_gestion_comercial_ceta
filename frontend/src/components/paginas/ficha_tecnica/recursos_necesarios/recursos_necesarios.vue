<template >
  ...
  <!--<div class="containerPrueba">-->
    <h1>Lista de los recursos necesarios</h1>
    <br>
    ...
    <table class="table" style="font-family: 'Bahnschrift'">
      ...
      <!--  <th scope="col" style="font-weight: bold" align="center">Nombre</th>-->
        ...
        <th scope="col" style="font-weight: bold"  >
          Nombre
          <span class="arrow" @click="ordenarPor('nombre_completo')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          Descripción
          <span class="arrow" @click="ordenarPor('descripcion')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          Cantidad
          <span class="arrow" @click="ordenarPorValor('cantidad')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          ...
          <span class="arrow" @click="ordenarPor('caracteristicas_especiales')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          Justificación
          <span class="arrow" @click="ordenarPor('justificacion')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          Valor unitario
          <span class="arrow" @click="ordenarPorValor('valor_unitario')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          Total
          <span class="arrow" @click="ordenarPorValor('total')">
              &#8593;&#8595;
            </span>
        </th>
      ...
      <tr v-for="(item, index) in lista_recursos_necesarios" :key="index">
        <th scope="row">{{ index + 1 }}</th>
        <td  >{{ item.nombre_completo }}</td>
        <td  >{{ item.descripcion }}</td>
        <td  >{{ item.cantidad }}</td>
        <td  >{{ item.caracteristicas_especiales }}</td>
    ...
    <div class="popup modal fade show d-block" v-if="mostrarPopup_de_Insertar" style="font-family: 'Bahnschrift'">
      <div class="popup-contenidoPlazos">
        <h2>Crear nueva</h2>
        <br>
        ...
        <div class="form-group row" style="align-items: baseline;">
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="insertar_nombre" id="insertar_nombre" v-model="popupItemNuevo.nombre_completo" required @input="validarNombre(popupItemNuevo)">
          </div>
          <div class="col-md-4">
            <h5>Descripción:</h5>
            <input type="text" class="form-control" name="insertar_descripcion" id="insertar_descripcion" v-model="popupItemNuevo.descripcion" required >
          </div>

          <div class="col-md-4">
            <h5>Cantidad:</h5>
            <input type="number" class="form-control" name="insertar_cantidad" id="insertar_cantidad" v-model="popupItemNuevo.cantidad" required min="1">
          </div>
        </div>
        ...
        <div class="form-group row" style="align-items: baseline;">
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="insertar_caracteristicas_especiales" id="insertar_caracteristicas_especiales" v-model="popupItemNuevo.caracteristicas_especiales" required>
          </div>
          <div class="col-md-4">
            <h5>Justificación:</h5>
            <input type="text" class="form-control" name="insertar_justificacion" id="insertar_justificacion" v-model="popupItemNuevo.justificacion" required >
          </div>

          <div class="col-md-4">
            <h5>Valor unitario:</h5>
            <input type="number" class="form-control" name="insertar_valor_unitario" id="insertar_valor_unitario" v-model="popupItemNuevo.valor_unitario" required min="1">
          </div>
        </div>
        <br>
        <!-- Grupo 3 de campos -->
        <div class="form-group row" style="align-items: baseline;">
          <div class="col-md-4">
              <button class="btn btn-icon-text" @click="calcularTotal(popupItemNuevo)" type="submit">
          ...
          <div class="col-md-4">
            <h5>Total:</h5>
            <input type="text" readonly class="form-control" name="insertar_total" id="insertar_total" v-model="popupItemNuevo.total" required>
          </div>
        </div>
    ...
    <div class="popup modal fade show d-block" v-if="mostrarPopup" style="font-family: 'Bahnschrift'">
      <div class="popup-contenidoPlazos" style="top: 33%">
        ...
        <div class="form-group row" style="align-items: baseline;">
          <div class="col-md-4">
            <h5>Nombre del recurso:</h5>
            <input type="text" class="form-control" name="insertar_nombre" id="insertar_nombre" v-model="popupItem.nombre_completo" required @input="validarNombre(popupItem)">
          </div>
          <div class="col-md-4">
            <h5>Descripción:</h5>
            <input type="text" class="form-control" name="insertar_descripcion" id="insertar_descripcion" v-model="popupItem.descripcion" required >
          </div>

          <div class="col-md-4">
            <h5>Cantidad:</h5>
            <input type="number" class="form-control" name="insertar_cantidad" id="insertar_cantidad" v-model="popupItem.cantidad" required min="1">
          </div>
        </div>
        ...
        <div class="form-group row" style="align-items: baseline;">
          <div class="col-md-4">
            <h5>Características especiales:</h5>
            <input type="text" class="form-control" name="insertar_caracteristicas_especiales" id="insertar_caracteristicas_especiales" v-model="popupItem.caracteristicas_especiales" required>
          </div>
          <div class="col-md-4">
            <h5>Justificación:</h5>
            <input type="text" class="form-control" name="insertar_justificacion" id="insertar_justificacion" v-model="popupItem.justificacion" required >
          </div>

          <div class="col-md-4">
            <h5>Valor unitario:</h5>
            <input type="number" class="form-control" name="insertar_valor_unitario" id="insertar_valor_unitario" v-model="popupItem.valor_unitario" required min="1">
          </div>
        </div>
        <br>
        <!-- Grupo 3 de campos -->
        <div class="form-group row" style="align-items: baseline;">
          <div class="col-md-4">
            <button class="btn btn-icon-text" @click="calcularTotal(popupItem)" type="submit">
              <img src="/iconos/Confirmar_30px.png" alt="Ícono de Confirmar" width="40" height="40">
              Calcular total
            </button>
          </div>
          ...
          <div class="col-md-4">
            <h5>Total:</h5>
            <input type="text" readonly class="form-control" name="insertar_total" id="insertar_total" v-model="popupItem.total" required>
          </div>
        </div>
...
export default {
  data() {
    return {
      lista_recursos_necesarios: [], // Array para almacenar los datos de la API
     ...
     // popupItemNuevo: null,
      ...
      /////para filtrar
      lista_recursos_necesarios_original: [], // Lista original
  ...
  mounted() {
    this.obtenerRecursos_necesarios();
  ...
  methods: {
    obtenerRecursos_necesarios() {
      axios.get('http://127.0.0.1:8000/api/recursos_necesarios/0')
          .then(response => {
            this.lista_recursos_necesarios = response.data["recursos_necesarios"];
            this.lista_recursos_necesarios_original = response.data["recursos_necesarios"];
           // this.lista_recursos_necesarios_original = response.data["recursos_necesarios"];
           // this.lista_recursos_necesarios = [...this.lista_recursos_necesarios_original]; // Copia la lista original a la lista filtrada
          })
          .catch(error => {
            console.error(error);
          });
    ...
    eliminar(id){
      ...
      const url = `http://127.0.0.1:8000/api/recursos_necesarios/delete/${id}`;
      axios.delete(url)
          .then(response => {
            this.obtenerRecursos_necesarios();
    ...
    guardarCambios() {
      ...
      if (this.popupItem.nombre_completo === '' ||
          this.popupItem.descripcion === '' ||
          this.popupItem.cantidad === 0 ||
          this.popupItem.caracteristicas_especiales === '' ||
          this.popupItem.justificacion === '' ||
          this.popupItem.valor_unitario === 0 ||
          this.popupItem.total === 0
      ) {
      ...
      const url = `http://127.0.0.1:8000/api/recursos_necesarios/put/${this.popupItem.id}`;
      const payload = {
        nombre_completo: this.popupItem.nombre_completo,
        descripcion: this.popupItem.descripcion,
        cantidad: this.popupItem.cantidad,
        caracteristicas_especiales: this.popupItem.caracteristicas_especiales,
        justificacion: this.popupItem.justificacion,
        valor_unitario: this.popupItem.valor_unitario,
        total: this.popupItem.total,
           // Otros campos a modificar si es necesario
      };

      axios.put(url, payload)
          .then(response => {
            this.obtenerRecursos_necesarios(); // Actualizar la tabla si es necesario
    ...
    guardar_nuevo() {
      ...
      if (
          !this.popupItemNuevo.nombre_completo ||
          this.popupItemNuevo.nombre_completo.trim() === ''
      ) {
      ...
      if (this.popupItemNuevo.nombre_completo === '' ||
          this.popupItemNuevo.descripcion === '' ||
          this.popupItemNuevo.cantidad === 0 ||
          this.popupItemNuevo.caracteristicas_especiales === '' ||
          this.popupItemNuevo.justificacion === '' ||
          this.popupItemNuevo.valor_unitario === 0 ||
          this.popupItemNuevo.total === 0
      ) {
        // Mostrar mensaje de error si el campo está vacío
        this.showErrorMessage = true;
        setTimeout(() => {
      ...
      const url = 'http://127.0.0.1:8000/api/recursos_necesarios/post/';
      const payload = {
        nombre_completo: this.popupItemNuevo.nombre_completo,

        descripcion: this.popupItemNuevo.descripcion,
        cantidad: this.popupItemNuevo.cantidad,
        caracteristicas_especiales: this.popupItemNuevo.caracteristicas_especiales,
        justificacion: this.popupItemNuevo.justificacion,
        valor_unitario: this.popupItemNuevo.valor_unitario,
        total: this.popupItemNuevo.total,
      };

      axios.post(url, payload)
          .then(response => {
            // Lógica después de crear el tipo de norma
            this.popupItemNuevo.nombre_completo = ''; // Limpiar el campo de texto
    ...
    validarNombre(item) {
      ...
      if (!regex.test(item.nombre_completo)) {
        // Si el valor no coincide con la expresión regular, eliminar caracteres no válidos
        item.nombre_completo = item.nombre_completo.replace(/[^a-zA-ZÁáÉéÍíÓóÚúÜü\s]/g, '');
    ...
    ordenarPor(columna) {
      ...
      this.lista_recursos_necesarios.sort((a, b) => {
    ...
    aplicarFiltro() {
      if (this.quitarFiltros) {
        ...
        this.lista_recursos_necesarios = [...this.lista_recursos_necesarios_original];
      } else {
        // Aplica el filtro por nombre
        const filteredList = this.lista_recursos_necesarios_original.filter(recurso => {
          const nombreMatch = (!this.filtroNombre || recurso.nombre_completo.includes(this.filtroNombre));
          return nombreMatch;
        });

        this.lista_recursos_necesarios = filteredList;
      }
    },
    ...
    abrirPopupInsertar(item) {
      ...
      this.popupItemNuevo.nombre_plazo = '';
      this.popupItemNuevo.remuneracion = 0;
      this.popupItemNuevo.cumplimiento_de_normas = false;
      this.popupItemNuevo.total_asignado = 0;
      this.popupItemNuevo.porcentaje = 0;
    },
