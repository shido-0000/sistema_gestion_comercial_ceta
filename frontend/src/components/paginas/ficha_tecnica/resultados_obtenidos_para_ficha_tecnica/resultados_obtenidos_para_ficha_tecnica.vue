<template >
  ...
  <!--<div class="containerPrueba">-->
    <h1>Lista de los resultados obtenidos</h1>
    <br>
    ...
    <table class="table" style="font-family: 'Bahnschrift'">
      ...
      <!--  <th scope="col" style="font-weight: bold" align="center">Nombre</th>-->
        ...
        <th scope="col" style="font-weight: bold"  >
          Nombre del producto
          <span class="arrow" @click="ordenarPor('nombre_producto_obtenido')">
              &#8593;&#8595;
            </span>
        </th>
        ...
        <th scope="col" style="font-weight: bold"  >
          ...
          <span class="arrow" @click="ordenarPor('descripcion_producto_obtenido')">
              &#8593;&#8595;
            </span>
        </th>
      ...
      <tr v-for="(item, index) in lista_resultados_obtenidos_para_ficha_tecnica" :key="index">
        <th scope="row">{{ index + 1 }}</th>
        <td >{{ item.nombre_producto_obtenido }}</td>
        <td >{{ item.descripcion_producto_obtenido }}</td>
    ...
    <div class="popup modal fade show d-block" v-if="mostrarPopup_de_Insertar" style="font-family: 'Bahnschrift'">
      <div class="popup-contenidoPlazos">
        ...
        <div class="form-group col" style="align-items: baseline;">

          <div class="col-md-12">
            <h5>Nombre del producto:</h5>
            <input type="text" class="form-control" name="insertar_nombre_producto_obtenido" id="insertar_nombre_producto_obtenido" v-model="popupItemNuevo.nombre_producto_obtenido" required >
          </div>

          <br>

          <div class="col-md-12">
            <h5>Descripción del tipo de entregable:</h5>
            <input type="text" class="form-control" name="insertar_descripcion_producto_obtenido" id="insertar_descripcion_producto_obtenido" v-model="popupItemNuevo.descripcion_producto_obtenido" required>
          </div>
          ...
          <div class="col-md-12">
            ...
            <input type="text" class="form-control" name="insertar_tipo_de_registro" id="insertar_tipo_de_registro" v-model="popupItemNuevo.tipo_de_registro" required>
          </div>
        </div>
    ...
    <div class="popup modal fade show d-block" v-if="mostrarPopup" style="font-family: 'Bahnschrift'">
      <div class="popup-contenidoPlazos" style="top: 33%">
        ...
        <div class="form-group col" style="align-items: baseline;">
          ...
          <div class="col-md-12">
            <h5>Nombre del producto:</h5>
            <input type="text" class="form-control" name="insertar_nombre_producto_obtenido" id="insertar_nombre_producto_obtenido" v-model="popupItem.nombre_producto_obtenido" required >
          </div>
          ...
          <div class="col-md-12">
            <h5>Descripción del tipo de entregable:</h5>
            <input type="text" class="form-control" name="insertar_descripcion_producto_obtenido" id="insertar_descripcion_producto_obtenido" v-model="popupItem.descripcion_producto_obtenido" required>
          </div>
          ...
          <div class="col-md-12">
            <h5>Tipo de registro:</h5>
            <input type="text" class="form-control" name="insertar_tipo_de_registro" id="insertar_tipo_de_registro" v-model="popupItem.tipo_de_registro" required>
          </div>
        </div>
...
export default {
  data() {
    return {
      lista_resultados_obtenidos_para_ficha_tecnica: [], // Array para almacenar los datos de la API
     ...
     // popupItemNuevo: null,
      ...
      /////para filtrar
      lista_resultados_obtenidos_para_ficha_tecnica_original: [], // Lista original
  ...
  methods: {
    obtenerResultados_obtenidos_para_ficha_tecnica() {
      axios.get('http://127.0.0.1:8000/api/resultados_obtenidos_para_ficha_tecnica/0')
          .then(response => {
            this.lista_resultados_obtenidos_para_ficha_tecnica = response.data["resultados_obtenidos_para_ficha_tecnica"];
            this.lista_resultados_obtenidos_para_ficha_tecnica_original = response.data["resultados_obtenidos_para_ficha_tecnica"];

            //this.lista_resultados_obtenidos_para_ficha_tecnica_original = response.data["resultados_obtenidos_para_ficha_tecnica"];
           // this.lista_resultados_obtenidos_para_ficha_tecnica = [...this.lista_resultados_obtenidos_para_ficha_tecnica_original]; // Copia la lista original a la lista filtrada
          })
          .catch(error => {
            console.error(error);
          });
    ...
    eliminar(id){
      ...
      const url = `http://127.0.0.1:8000/api/resultados_obtenidos_para_ficha_tecnica/delete/${id}`;
      axios.delete(url)
          .then(response => {
            this.obtenerResultados_obtenidos_para_ficha_tecnica();
    ...
    guardarCambios() {
      ...
      if (this.popupItem.nombre_producto_obtenido === '' ||
          this.popupItem.descripcion_producto_obtenido === '' ||
      ...
      const url = `http://127.0.0.1:8000/api/resultados_obtenidos_para_ficha_tecnica/put/${this.popupItem.id}`;
      const payload = {
        nombre_producto_obtenido: this.popupItem.nombre_producto_obtenido,
        descripcion_producto_obtenido: this.popupItem.descripcion_producto_obtenido,
      ...
      axios.put(url, payload)
          .then(response => {
            this.obtenerResultados_obtenidos_para_ficha_tecnica(); // Actualizar la tabla si es necesario
    ...
    guardar_nuevo() {
      ...
      if (this.popupItemNuevo.nombre_producto_obtenido === '' ||
          this.popupItemNuevo.descripcion_producto_obtenido === '' ||
      ...
      const url = 'http://127.0.0.1:8000/api/resultados_obtenidos_para_ficha_tecnica/post/';
      const payload = {
        nombre_producto_obtenido: this.popupItemNuevo.nombre_producto_obtenido,
        descripcion_producto_obtenido: this.popupItemNuevo.descripcion_producto_obtenido,
    ...
    ordenarPor(columna) {
      ...
      this.lista_resultados_obtenidos_para_ficha_tecnica.sort((a, b) => {
    ...
    aplicarFiltro() {
      if (this.quitarFiltros) {
        ...
        this.lista_resultados_obtenidos_para_ficha_tecnica = [...this.lista_resultados_obtenidos_para_ficha_tecnica_original];
      } else {
        // Aplica el filtro por nombre
        const filteredList = this.lista_resultados_obtenidos_para_ficha_tecnica_original.filter(resultado => {
          const nombreMatch = (!this.filtroNombre || resultado.nombre_producto_obtenido.includes(this.filtroNombre));
          return nombreMatch;
        });

        this.lista_resultados_obtenidos_para_ficha_tecnica = filteredList;
      }
    },
